...
fun MappableContent.sub(subName: String): TR =
    AtlasU.sub(this, subName)

fun MappableContent.inMod(subName: String): TR =
    AtlasU.inMod(this, subName)

fun inMod(subName: String): TR {
    return AtlasU.inMod(subName)
}
...
fun MappableContent.anim(subName: String? = null, number: Int): Array<TR> =
    AtlasU.animation(this, subName, number)
/**
...
fun MappableContent.sheet(subName: String? = null, number: Int): Array<TR> =
    AtlasU.sheet(this, subName, number)
/**
