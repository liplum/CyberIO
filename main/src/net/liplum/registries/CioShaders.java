...
public class CioShaders {
    ...
    public static CommonShader TvStatic;
    ...
    public static ProgressShader InvertingColorRbg2HsvInRgb;
    public static ProgressShader Monochromize;
    public static SurfaceShader Cyberion;
    public static TestShieldShader TestShieldScreen;
    public static HologramShader TestScreen;
}
